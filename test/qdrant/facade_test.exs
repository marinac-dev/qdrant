defmodule Qdrant.FacadeTest do
  ...
  @operations [
    ...
    {:get_point, 2, true, 1},
    {:get_points, 2, true, 1},
    {:upsert_points, 2, true, 2},
    {:delete_points, 2, true, 2},
    {:set_payload, 2, true, 2},
    {:overwrite_payload, 2, true, 2},
    {:delete_payload, 2, true, 2},
    {:clear_payload, 2, true, 2},
    {:batch_update_points, 2, true, 2},
    ...
    {:update_vectors, 2, true, 2},
    {:delete_vectors, 2, true, 2},
    ...
    {:create_field_index, 2, true, 2},
    {:delete_field_index, 2, true, 2},
