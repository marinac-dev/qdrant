defmodule Qdrant do
  ...
  @operations [
    ...
    {Points, :get_points, 2, true, {:positional, [consistency: nil]}},
    {Points, :upsert_points, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :delete_points, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :set_payload, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :overwrite_payload, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :delete_payload, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :clear_payload, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :batch_update_points, 2, true, {:positional, [wait: false, ordering: nil]}},
    ...
    {Points, :update_vectors, 2, true, {:positional, [wait: false, ordering: nil]}},
    {Points, :delete_vectors, 2, true, {:positional, [wait: false, ordering: nil]}},
    ...
    {Indexes, :create_field_index, 2, true, {:positional, [wait: nil, ordering: nil]}},
    {Indexes, :delete_field_index, 2, true, {:positional, [wait: nil, ordering: nil]}},
    ...
    {Service, :telemetry, 0, true, {:positional, [anonymize: nil, details_level: nil]}},
    {Service, :metrics, 0, true, {:positional, [anonymize: nil]}},
